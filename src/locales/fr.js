...
export const fr = {
  ...
  CARTONET: {
    ...
    TRAINING: {
      ...
      FORM_EXISTING_APTITUDES_LABEL: "Compétences à sélectionner pour la formation",
    },
    HOBBY: {
      ...
      FORM_APTITUDES_LABEL: "Compétences sélectionnées pour l'expérience extra-professionnelle",
      FORM_EXISTING_APTITUDES_LABEL: "Compétences à sélectionner pour l'expérience extra-professionnelle",
    },
    SKILL: {
