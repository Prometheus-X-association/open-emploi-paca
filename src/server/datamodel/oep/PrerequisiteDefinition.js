...
export default class PrerequisiteDefinition extends ModelDefinitionAbstract {
  /**
   * @inheritDoc
   */
  ...
  static getLinks() {
    return [
      ...
      new LinkDefinition({
        ...
        rdfObjectProperty: "oep:isMadeOf",
  ...
  static getLiterals() {
    return [
      ...
      new LiteralDefinition({
        ...
        rdfDataProperty: "oep:isMandatory",
